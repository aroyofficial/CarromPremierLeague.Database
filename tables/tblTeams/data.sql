...
MERGE INTO [dbo].[tblTeams] AS Target
USING (VALUES
...
) AS Source ([Id], [Name], [Slogan], [LogoUrl])
...
WHEN NOT MATCHED BY TARGET THEN
    INSERT ([Id], [Name], [Slogan], [LogoUrl])
    VALUES (Source.[Id], Source.[Name], Source.[Slogan], Source.[LogoUrl]);
GO
